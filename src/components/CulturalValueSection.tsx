      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Batik bukan hanya seni, tetapi juga sistem nilai yang mengatur kehidupan sosial, 
            spiritual, dan budaya masyarakat Indonesia sejak berabad-abad lalu.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Batik masih digunakan dalam berbagai upacara adat dan perayaan tradisional. 
                Dari kelahiran hingga pernikahan, batik menjadi saksi perjalanan hidup masyarakat Indonesia.
              </p>
