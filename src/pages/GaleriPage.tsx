    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Pesona Motif Batik Nusantara</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Batik Indonesia tidak hanya sekadar kain, tetapi juga simbol budaya, tradisi, dan filosofi kehidupan. Setiap motif batik memiliki makna mendalam yang diwariskan dari generasi ke generasi. Mari kita kenali motif-motif batik
            populer berikut.
          </p>
        </div>
      </section>
      ...
      {/* Gallery Section */}
      <div id="galeri">
        <GalleryGrid title="Koleksi Motif Batik" items={galleryItems} />
      </div>

      {/* Slider Section */}
      <MotifSlider title="Eksplorasi Motif Batik" content="Geser untuk melihat lebih banyak motif batik yang memukau dari berbagai daerah di Indonesia." items={sliderItems} autoplay={true} />

      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/5">
        <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Ingin Tahu Lebih Banyak?</h2>
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">Temukan filosofi lengkap dari setiap motif batik dan bagaimana batik menjadi warisan dunia yang diakui UNESCO.</p>
          <Button variant="contact" size="lg" onClick={() => navigate("/sejarah")}>
