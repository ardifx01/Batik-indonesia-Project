  ...
  const motifs = [
    {
      ...
      detailedContent: "Motif parang memiliki pola diagonal berulang yang menyerupai gelombang laut. Dalam filosofi Jawa, parang melambangkan kekuatan yang tidak pernah putus dan keberanian dalam menghadapi berbagai rintangan hidup. Motif ini sering digunakan dalam upacara adat dan acara formal sebagai simbol kepemimpinan.",
      color: "orange",
    ...
    },
    {
      ...
      detailedContent: "Kawung adalah salah satu motif tertua dalam tradisi batik Jawa. Bentuk geometris yang elegan ini terinspirasi dari irisan buah aren (kawung) dan melambangkan kesucian, keluhuran budi, serta harmoni dalam kehidupan. Motif ini sering digunakan dalam berbagai upacara spiritual dan keagamaan.",
      color: "purple",
    ...
    },
    {
      ...
      detailedContent: "Megamendung berasal dari daerah Cirebon dan menggambarkan bentuk awan yang berlapis-lapis. Motif ini melambangkan kesabaran, ketenangan, dan harapan. Dalam filosofi Jawa, awan yang menutupi matahari memberikan kesejukan, sama seperti kesabaran yang membawa kedamaian dalam hidup.",
      color: "turquoise",
    ...
    },
    {
      ...
      detailedContent: "Truntum memiliki pola bunga-bunga kecil yang tersebar merata, melambangkan cinta kasih yang tumbuh dan berkembang. Motif ini sering digunakan dalam upacara pernikahan sebagai simbol harapan agar cinta pasangan terus tumbuh dan berkembang sepanjang masa.",
      color: "pink",
      ...
      <section className="pt-28 pb-16 bg-gradient-hero">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p 
            ...
            data-aos-delay="200"
          >
            Jelajahi keindahan dan filosofi mendalam di balik setiap motif batik. 
            Setiap goresan memiliki makna yang tersimpan dalam kearifan lokal nusantara.
          </p>
        </div>
      </section>
              ...
              >
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div>
                      <h4 className={`text-lg font-semibold text-${motif.color} mb-2`}>
                        Filosofi: {motif.philosophy}
                      </h4>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                ...
                kearifan lokal dan nilai-nilai budaya setempat yang telah diwariskan 
                turun-temurun.
              </p>
